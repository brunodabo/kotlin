...
public class InjectorForModuleAwareLazyResolveWithJava {
    ...
    private final ModuleDescriptorBase module;
    ...
    public InjectorForModuleAwareLazyResolveWithJava(
